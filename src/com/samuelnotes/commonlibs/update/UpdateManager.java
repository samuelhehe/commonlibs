package com.samuelnotes.commonlibs.update;
...
import com.samuelnotes.commonlibs.model.Update;
...
//				try {					
//					Update update = AppContext.checkVersion((AppContext)mContext.getApplicationContext());
					Update update = null;
					msg.what = 1;
					msg.obj = update;
