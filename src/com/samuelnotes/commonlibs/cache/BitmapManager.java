package com.samuelnotes.commonlibs.cache;
...
import com.samuelnotes.commonlibs.cache.image.ImageDownloader;
import com.samuelnotes.commonlibs.utils.FileUtils;
import com.samuelnotes.commonlibs.utils.ImageUtils;
...
public class BitmapManager {
	...
	private Bitmap downloadBitmap(String url, int width, int height) {
		Bitmap bitmap = null;
			//http加载图片
			bitmap = imageDownloader.downloadBitmap(url);
			if (width > 0 && height > 0) {
				//指定显示图片的高宽
